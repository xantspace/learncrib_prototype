  ...
  return (
    <div className="min-h-svh flex flex-col px-6 pt-12 pb-10">
      ...
      <div className="mb-5 animate-slide-up">
        <img src="/assets/img/logo_b.png" alt="LearnCrib" className="h-10 mb-2 object-contain" />
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4 animate-slide-up" style={{ animationDelay: '0.1s' }}>
        ...
        <div className="grid grid-cols-2 gap-3">
          <button type="button" className="bg-white/70 backdrop-blur-glass border border-white/45 rounded-2xl flex items-center justify-center gap-2 py-3 px-4 text-sm font-inter font-medium text-secondary hover:border-secondary/30 transition-colors">
